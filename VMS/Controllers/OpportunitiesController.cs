...
{    
    public class OpportunitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,OpportunityName,Address1,Address2,City,State,Zip,Country,Description,Requirements,CreateDate")] Opportunity opportunity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OpportunityName,Address1,Address2,City,State,Zip,Country,Description,Requirements,CreateDate")] Opportunity opportunity)
        {
